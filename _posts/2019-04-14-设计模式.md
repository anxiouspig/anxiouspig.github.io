...
public interface Observer {
    /**
     * 无论何时，被观察对象状态改变，则会触发Observable的notifyObservers方法
     * 来通知所有观察者。
     *
...
/**
 * 被观察者
 * 通知的顺序的默认实现是后添加的先通知，子类可以自定义这个顺序，
 * 通知需要在单独的线程，子类也应该保证这点。
 * @author  Chris Warth
 * @since   JDK1.0
 */
public class Observable {
    ...
    /**
     * setChanged()用于标记对象状态已经改变的事实，当changed为true，触发观察者的update响应，</br>
